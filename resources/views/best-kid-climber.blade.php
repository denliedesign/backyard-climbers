...
@section('content')
    ...
    <div class="container">
        ...
        <p class="text-muted text-center p-0 m-0"><small>July 30, 2020</small></p>
        <div class="table-responsive">
            <table class="table ratings-summary my-5 mt-0">
                ...
                <tr>
                    <td>1</td>
                    <td><img style="height: 100px; width: auto;" src="/images/step2-skyward-summit-kid-climber.jpg" alt="" class=""></td>
                    <td>Step2 Skyward Summit</td>
                    <td>4-8</td>
                    <td>$538.53</td>
                    <td><a href="https://amzn.to/2EvWYS1" target="_blank"><button class="btn text-white">Amazon</button></a></td>
                </tr>
                <tr>
                    <td>2</td>
                ...
                <tr>
                    ...
                    <td>1.5-5</td>
                    <td>$138.28</td>
                    <td><a href="https://amzn.to/3fcMIed" target="_blank"><button class="btn text-white">Amazon</button></a></td>
                </tr>
    ...
    <div class="bg-green">
        <div class="container py-5">
            <div class="row">
                <div class="col-sm">
                    <img src="/images/step2-skyward-summit-kid-climber.jpg" alt="" class="img-fluid">
                </div>
                <div class="col-sm">
                    <div class="number-one d-inline">1</div>
                    <h2 style="color: goldenrod;" class="d-inline">BEST OVERALL</h2>
                    <h2 class="text-white d-inline">Skyward Summit</h2>
                    <p class="text-white">
                        Step2's Skyward Summit is my pick for overall best kid climber.
